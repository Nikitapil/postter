<template>
  <div
    class="bg-blue-100 dark:bg-dim-300 w-full border-b p-3 dark:text-white cursor-pointer hover:bg-blue-200 dark:hover:bg-dim-400 default-transition overflow-hidden"
  >
