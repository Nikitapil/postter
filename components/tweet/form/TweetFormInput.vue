<!-- TODO decompose this component (especially icons) -->
<template>
  <div>
    ...
    <div class="p-4 pl-16">
      ...
      <img v-if="inputImageUrl" class="rounded-2xl border max-h-[120px]" :src="inputImageUrl" alt="uploaded image">
      <input
          hidden
          type="file"
          ref="imageInput"
    ...
    <div class="flex p-2 pl-14">
      ...
      <div class="flex w-full text-white">
        <div class="p-2 text-blue-400 rounded-full hover:bg-blue-50 dark:bg-dim-800 cursor-pointer" @click="handleImageClick">
        ...
        <div class="p-2 text-blue-400 rounded-full hover:bg-blue-50 dark:bg-dim-800 cursor-pointer">
          <svg viewBox="0 0 24 24" class="w-5 h-5" fill="currentColor">
            <g>
              <path
      ...
      <div class="ml-auto">
        <AppButton size="sm" @click="handleFormSubmit" :disabled="isDisabled">Tweet</AppButton>
      </div>
...
const handleImageChange = (event: InputEvent) => {
  ...
  if (file) {
    ...
    // TODO create component with uploader and this helper with file reader
    const reader = new FileReader()

    reader.onload = (event) => {
      inputImageUrl.value = (event.target?.result as string) || null
    }
